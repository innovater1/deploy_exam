	...
	<body>
		...
		<div class="container">
			<div class="form-group  row">
					...
					<div class="col-sm-10">
						<input type="text" name="birthyy" maxlength="4" placeholder="년(4자)" size="6" value="<%=birthdayArr[0]%>">
						<select name="birthmm">
							<option value="<%=birthdayArr[1]%>">월</option>
							<%
								for (int i = 1; i <= 12; i++) {
						...
						<input type="text" name="birthdd" maxlength="2" placeholder="일" size="4" value="<%=birthdayArr[2]%>">
					</div>
			</div>
		</div>
		<div class="container">
